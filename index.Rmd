...
gov_type_colour <- c("All Debate.Government" = "#006332",
                    "All Debate.Opposition" = "#99C0AD",
                    "Disability.Government" = "#250858",
                    "Disability.Opposition" = "#A79CBC")
...
This app was constructed using [`shiny`](http://shiny.rstudio.com/). Plots are produced with `ggplot2` and `scales`. Sentiment analysis was conducted using the [`sentimentr`](https://cran.r-project.org/package=sentimentr), [`syuzhet`](https://cran.r-project.org/package=syuzhet) and [`lexicon`](https://cran.r-project.org/package=lexicon) packages.
