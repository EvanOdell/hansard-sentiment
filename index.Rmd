...
ui <- fluidPage(
  fluidRow(
                         conditionalPanel(
                           ...
                           tags$em(tags$h4("Sentiment Line Chart")),
                           plotOutput("sentiplot")
                           ),
                         conditionalPanel(
                           condition = "input.toggle % 3 == 2",
                           tags$em(tags$h4("Sentiment Box Chart")),
                           plotOutput("sentibox")
                           ),
                         conditionalPanel(
                           condition = "input.toggle % 3 == 1",
                           tags$em(tags$h4("Sentiment Bar Chart")),
                           plotOutput("sentibar")
                         )
...
<a name="gov_dis"></a>
These charts show the scores for all debate and disability debate, seperated between government and opposition, from 1993 <!-- Check date here!-->to the end of 2016.
  ...
  fluidRow(  conditionalPanel(
       ...
       fluidRow(
         ...
         column(width = 4,
                      ...
                      sliderInput("senti_year2", "Year", 1993, 2016,
                                   value = c(1993, 2016), sep=""),
                       actionButton("toggle", "Switch Chart Type")
...
p8 + geom_bar(stat = "identity", position = "dodge") +
  scale_x_discrete(name="Year", breaks=seq(1990,2020, by=2)) + 
  scale_y_continuous(name="Sentiment Score") + 
...
### By Party
<a name="party_dis"></a>
These charts show the scores for all debate and disability debate, seperated between different parties, from 1993 <!-- Check date here!-->to the end of 2016. The Conservatives and Liberal Democrats are their own parties, and Labour and Labour Co-op MPs are grouped together as Labour. All other parties are grouped together as Other. <!-- As and when, add SDP to liberal democrats -->
...
<a name="notes"></a>
The source code for this app is available on [Github](https://github.com/EvanOdell/hansard-sentiment). For assistance, questions or comments please contact [Evan Odell](http://evanodell.com) via [email](mailto:evan.odell@disabilityrightsuk.org) or [Twitter](https://twitter.com/evanodell), or raise an issue on Github.
...
The computer code used in this app is licensed under an [MIT License](https://github.com/EvanOdell/hansard-sentiment/blob/master/LICENSE). All other content on this page is licensed under a <a rel="license" href="http://creativecommons.org/licenses/by-sa/4.0/">Creative Commons Attribution-ShareAlike 4.0 International License</a>. <a rel="license" href="http://creativecommons.org/licenses/by-sa/4.0/"><img alt="Creative Commons Licence" style="border-width:0" src="https://i.creativecommons.org/l/by-sa/4.0/80x15.png" /></a>
