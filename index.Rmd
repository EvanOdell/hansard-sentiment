...
<a name="gov_dis"></a>
These charts show the scores for all debate and disability debate, seperated between government and opposition, from 1992 <!-- Check date here!-->to the end of 2016.
  ...
  fluidRow(  conditionalPanel(
       ...
       fluidRow(
         ...
         column(width = 4,
                      ...
                      sliderInput("senti_year2", "Year", 1992, 2016,
                                   value = c(1992, 2016), sep=""),
                       actionButton("toggle", "Switch Chart Type")
...
### By Party
<a name="party_dis"></a>
These charts show the scores for all debate and disability debate, seperated between different parties, from 1992 <!-- Check date here!-->to the end of 2016. The Conservatives and Liberal Democrats are their own parties, and Labour and Labour Co-op MPs are grouped together as Labour. All other parties are grouped together as Other. <!-- As and when, add SDP to liberal democrats -->
